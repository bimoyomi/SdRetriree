...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {/* 히어로 섹션 */}
      <section id="home" className="pt-40 pb-24 px-4 sm:px-6 lg:px-8 relative">
        {/* 배경 이미지 */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-start">
            <div className="text-center lg:text-left">
              <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-gray-900 mb-6 leading-tight">
                <span className="bg-gradient-to-r from-orange-500 to-red-500 bg-clip-text text-transparent">경매 낙찰 받은 집,</span>
                <br />
                쌓여있는 짐 때문에
                <br />
                <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">머리가 아프신가요?</span>
              </h1>
              <p className="text-lg sm:text-xl text-gray-600 mb-8 leading-relaxed px-4 lg:px-0 text-center lg:text-left">
                남겨진 가구, 가전제품, 쓰레기까지<br />
                하루 만에 말끔히 비워드립니다.
              </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 text-sm sm:text-base">
                낙찰 받은 집 정리 전문업체입니다.
                <br />
                빠르고 깔끔한 정리 서비스를 제공합니다.
              </p>
            </div>
            <div>
              <h4 className="font-semibold mb-4">서비스</h4>
              <ul className="space-y-2 text-gray-400 text-sm sm:text-base">
                <li><a href="#" className="hover:text-white transition-colors">가구 정리</a></li>
                <li><a href="#" className="hover:text-white transition-colors">가전제품 정리</a></li>
                <li><a href="#" className="hover:text-white transition-colors">쓰레기 정리</a></li>
              </ul>
            </div>
            <div>
